...
export default function NewReadingExercisePage() {
  ...
  const onSubmit = async (data: ExerciseForm) => {
    try {
      ...
      toast.error(error instanceof Error ? error.message : 'Erro ao criar exercício')
    } finally {
      setLoading(false)
    }
  }
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      <div className="flex items-center gap-3 mb-6">
        ...
        <h1 className="text-2xl font-bold">Novo Exercício de Leitura</h1>
      </div>
          ...
          <div className="space-y-6">
            <div>
              ...
              <input
                ...
                placeholder="Ex: Compreensão de Texto - Capítulo 1"
              />
              {errors.title && (
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full p-2 border rounded-md mt-1"
                rows={3}
                placeholder="Ex: Leia o texto e responda as questões"
              />
              {errors.description && (
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full p-2 border rounded-md mt-1"
                rows={6}
                placeholder="Digite o texto do exercício aqui..."
              />
              {errors.content && (
